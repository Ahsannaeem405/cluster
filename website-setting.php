		...
		<div class="row">
			<div class="col col-lg-8 m-auto col-md-8 col-sm-12 col-12">
				<div class="main-header-content">
					...
					<p>Welcome to Setting, Here you can edit your website details</p>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="row">
							...
							<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="form-group label-floating d-flex upload-logo align-items-center">
									<div class="w-50">
										<h6>Website Logo</h6>
										<button class="btn btn-primary w-100" onclick="document.getElementById(logo-upload).clicked"> upload logo
										</button>
										<input class="form-control" placeholder="" type="file" value="Cluster" hidden id="logo-upload">
									</div>
									<div class="site-img" style="width:50%; height:50px"><img src="./img/logo.png"/ style="height:50px"></div>
								</div>
							</div>
						</div>
						<div class="row">
