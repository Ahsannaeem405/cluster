                ...
                <div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mb-3">
                    <div class="ui-block h-100 mb-0">
                        ...
                        <div class="friend-item friend-groups">
                            ...
                            <a  <?php if(Auth::user()->role == 'admin'): ?> href="<?php echo e(url("$role/Join/cluster", $list->id)); ?>" <?php else: ?>  href="<?php echo e(url("$role/view/cluster", $list->id)); ?>" <?php endif; ?>>
                            ...
                            <div class="friend-item-content">
                                ...
                                <div class="friend-avatar">
                                    <div class="author-thumb">
                                        <img loading="lazy" src="<?php echo e(asset('images')); ?>/<?php echo e($list->image); ?>" alt="Olympus" width="34" height="34">
                                    </div>
                                    <div class="author-content">

                                        <a  class="h5 author-name"><?php echo e($list->name); ?></a>
                                ...
                                <div class="control-block-button">
                                    ...
                                    <a href="<?php echo e(url('/user/Join/cluster', $list->id)); ?>" class="btn btn-control "
                                        style="background:#ff5e3a;    color: white; ">
                                        <i class="fa fa-plus"></i>
                                    </a>

                                <?php else: ?>
                                    <a style="    color: white;" href="<?php echo e(url('user/deleteCluster')); ?>/<?php echo e($list->id); ?>"
                    ...
                    <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="<?php echo e(url('admin/updateCluster')); ?>/<?php echo e($list->id); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input list="browsers" name="manager_id" value="<?php echo e($list->manager_id); ?>"
                                            placeholder="Select Manager"
                                            class="form-control <?php $__errorArgs = ['manager_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <datalist id="browsers">
                                            <?php $__currentLoopData = $manager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($list->id); ?>"><?php echo e($list->first_name); ?></option>
    ...
    <div class="modal fade" id="create-friend-group-1" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo e(url('admin/createCluster')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Cluster Name</label>
...
unset($__errorArgs, $__bag); ?>">
                            <datalist id="browsers">
                                <?php $__currentLoopData = $manager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($list->first_name); ?>"><?php echo e($list->first_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </datalist>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cluster\cluster\resources\views/admin/view_cluster.blade.php ENDPATH**/ ?>