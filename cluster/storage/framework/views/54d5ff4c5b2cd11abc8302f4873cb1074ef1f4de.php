...
<div class="fixed-sidebar left">
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
		...
		<a href="<?php echo e(url('admin')); ?>" class="logo">
			<div class="img-wrap">
				<img loading="lazy" src="<?php echo e(asset('img/white-logo.png')); ?>" alt="logo-tital" width="50" height="50">
			</div>
		</a>
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="left-menu">
				...
				<li>
					<a href="<?php echo e(url("$role/services")); ?>">
				...
				<li>
					<a href="<?php echo e(url("$role/view/event")); ?>">
				...
				<li>
					<a href="<?php echo e(url("$role/members")); ?>">
				...
				<li>
					<a href="<?php echo e(url("$role/users")); ?>">
				...
				<li>
					<a href="<?php echo e(url("$role/cluster_manager")); ?>">
				...
				<li>
					<a href="<?php echo e(url("$role/communication")); ?>">
				...
				<li>
					<a href="<?php echo e(url("$role/setting")); ?>">
	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
		<a href="#" class="logo">
			<div class="img-wrap">
				<img loading="lazy" src="<?php echo e(asset('img/white-logo.png')); ?>" alt="logo-tital" width="34" height="34">
			</div>
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="left-menu">
				...
				<li>
					<a href="<?php echo e(url("$role/view_cluster")); ?>">
						<svg class="olymp-star-icon left-menu-icon" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="FAV PAGE">
							<use xlink:href="#olymp-star-icon"></use>
						</svg>
...
<div class="fixed-sidebar left fixed-sidebar-responsive">
	...
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left-responsive">
		<a href="#" class="logo js-sidebar-open">
			<img loading="lazy" src="<?php echo e(asset('img/white-logo.png')); ?>" alt="white-logo" width="34" height="34">
		</a>
	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1-responsive">
		<a href="#" class="logo">
			<div class="img-wrap">
				<img loading="lazy" src="<?php echo e(asset('img/logo.png')); ?>" alt="white-logo" width="34" height="34">
			</div>
			<div class="title-block">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			...
			<div class="control-block">
				<div class="author-page author vcard inline-items">
					<div class="author-thumb">
						<img alt="author" src="<?php echo e(asset('img/author-page.html')); ?>" width="36" height="36" class="avatar">
			...
			<ul class="account-settings">
				<li>
					<a href="<?php echo e(url("$role/profile_setting")); ?>">
		...
		<div class="tab-pane fade" id="request" role="tabpanel" aria-labelledby="request-tab">
			...
			<div class="mCustomScrollbar" data-mcs-theme="dark">
				...
				<ul class="notification-list friend-requests">
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar55-sm.webp')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar56-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
					...
					<li class="accepted">
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar57-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
							You and
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar58-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
			...
			<div class="mCustomScrollbar" data-mcs-theme="dark">
				...
				<ul class="notification-list chat-message">
					<li class="message-unread">
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar59-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar60-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar61-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
					...
					<li class="chat-group">
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar11-sm.html')); ?>" alt="author" width="16" height="16">
							<img loading="lazy" src="<?php echo e(asset('img/avatar12-sm.html')); ?>" alt="author" width="16" height="16">
							<img loading="lazy" src="<?php echo e(asset('img/avatar13-sm.html')); ?>" alt="author" width="16" height="16">
							<img loading="lazy" src="<?php echo e(asset('img/avatar10-sm.html')); ?>" alt="author" width="36" height="36">
						</div>
						<div class="notification-event">
		...
		<div class="tab-pane fade" id="notification" role="tabpanel" aria-labelledby="notification-tab">
			...
			<div class="mCustomScrollbar" data-mcs-theme="dark">
				...
				<ul class="notification-list">
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar62-sm.html')); ?>" width="34" height="34" alt="author">
						</div>
						<div class="notification-event">
					...
					<li class="un-read">
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar63-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
							<div>You and
					...
					<li class="with-comment-photo-wrap">
						<div class="with-comment-photo">
							<div class="author-thumb"><img loading="lazy" src="<?php echo e(asset('img/avatar64-sm.html')); ?>" width="34" height="34" alt="author"></div>
							<div class="notification-event">
						...
						<div class="comment-photo"><img loading="lazy" src="<?php echo e(asset('img/comment-photo1.html')); ?>" alt="photo" width="40" height="40">
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar65-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
							<div>
					...
					<li>
						<div class="author-thumb">
							<img loading="lazy" src="<?php echo e(asset('img/avatar66-sm.html')); ?>" alt="author" width="34" height="34">
						</div>
						<div class="notification-event">
...
<?php /**PATH C:\xampp\htdocs\cluster\cluster\resources\views/admin1/layout/header.blade.php ENDPATH**/ ?>