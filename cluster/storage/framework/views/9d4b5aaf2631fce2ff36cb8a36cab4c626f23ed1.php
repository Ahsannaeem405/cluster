                            ...
                            <div class="today-events calendar">
                                ...
                                <div class="list">
                                    <div class="control-block-button">
                                        ...
                                        <?php if(isset($mang->status) && $mang->status == 2 || Auth::user()->role == 'admin'): ?>
                                    ...
                                    <div class="ui-block">
                                        <article class="hentry post video">
                                            <div class="post__author author vcard inline-items">
                                                <img loading="lazy" src="<?php echo e(asset('img/avatar7-sm.html')); ?>" alt="author"
                                                    width="42" height="42">

                                                <div class="author-date">
                                                    <a class="h6 post__author-name fn"
                                                        href="#"><?php echo e($events->Event->User->first_name); ?>

                                                        <?php echo e($events->Event->User->last_name); ?></a> shared a <a
                                                        href="#">link</a>
                                                    <div class="post__date">
                                                        <time class="published" datetime="2004-07-24T18:18">
                                                            <?php echo e($events->datetimepicker); ?>

                                                            <?php echo e($events->time); ?><?php echo e($events->time_type); ?>
                                            ...
                                            <p>Hey <a href="#"><?php echo e($events->Event->User->first_name); ?></a>
                                                <?php echo e($events->description); ?></p>

                                            <div class="col-12 text-end">

                                                <?php if($ii != $events->id): ?>
                                                    <a href="<?php echo e(url("$role/view/join", [$events->id, $events->Event->cluster_id])); ?>"
                                ...
                                <?php $__currentLoopData = $manager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $managers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="inline-items">
                                        ...
                                        <div class="notification-event">
                                            <a href="#" class="h6 notification-friend"><?php echo e($managers->User->first_name); ?>

                                                <?php echo e($managers->User->last_name); ?></a>
                                        </div>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="ui-block text-center">
                            ...
                            <ul class="widget w-activity-feed notification-list">
                                ...
                                <li style=" background: #2d2d2d; padding: 7px;">
                                    <div class="col-12">
                                        <a href="<?php echo e(url("$role/view",[$id])); ?>"
