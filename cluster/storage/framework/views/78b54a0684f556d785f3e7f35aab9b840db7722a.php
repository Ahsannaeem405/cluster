...
<script src="<?php echo e(asset('js/libs/swiper.jquery.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/libs/jquery.appear.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/libs/Chart.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/libs/chartjs-plugin-deferred.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/libs/circle-progress.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/libs/loader.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/libs/run-chart.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\cluster\cluster\resources\views\admin1\layout\footer.blade.php ENDPATH**/ ?>