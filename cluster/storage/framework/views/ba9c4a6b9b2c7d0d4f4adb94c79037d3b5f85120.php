                            ...
                            <div class="today-events calendar">
                                ...
                                <div class="list">
                                    <div class="control-block-button">
                                        ...
                                        <?php if( isset($mang->status) && $mang->status == 2): ?>
...
<?php if($events->Event->cluster_id == $id): ?>




<?php $__currentLoopData = $joinn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php if($item->event_id == $events->id): ?>
<?php
$ii =$events->id;
                            ...
                            <div class="ui-block">
                                <article class="hentry post video">
                                    <div class="post__author author vcard inline-items">
                                        <img loading="lazy" src="<?php echo e(asset('img/avatar7-sm.html')); ?>" alt="author" width="42"
                                            height="42">

                                        <div class="author-date">
                                            <a class="h6 post__author-name fn" href="#"><?php echo e($events->Event->User->first_name); ?> <?php echo e($events->Event->User->last_name); ?></a> shared a <a
                                                href="#">link</a>
                                            <div class="post__date">
                                                <time class="published" datetime="2004-07-24T18:18">
                                                   <?php echo e($events->datetimepicker); ?> <?php echo e($events->time); ?><?php echo e($events->time_type); ?>
                                    ...
                                    <p>Hey <a href="#"><?php echo e($events->Event->User->first_name); ?></a> <?php echo e($events->description); ?></p>

                                    <div class="col-12 text-end">

                                        <?php if($ii != $events->id ): ?>
                                        <a href="<?php echo e(url("$role/view/join",[$events->id,$events->Event->cluster_id])); ?>" class="btn btn-primary" > Join</a>
                                        <?php else: ?>
                            ...
                            <ul class="widget w-friend-pages-added notification-list friend-requests">
                                ...
                                <li class="inline-items">
                                    <div class="author-thumb">
                                        <img loading="lazy" src="<?php echo e(asset('/img/avatar38-sm.html')); ?>" alt="author"
                                            width="36" height="36">
                                    </div>
                                    <div class="notification-event">
                                        <a href="#" class="h6 notification-friend"><?php echo e($managers->User->first_name); ?> <?php echo e($managers->User->last_name); ?></a>
                                    </div>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="ui-block text-center">
                            ...
                            <ul class="widget w-activity-feed notification-list">
                                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li>
                                        <div class="author-thumb">
                                            <img loading="lazy" src="<?php echo e(asset('img/avatar49-sm.html')); ?>" alt="author"
                                                width="28" height="28">
                                        </div>
                                        <div class="notification-event">
                                            <b style="    font-size: 14px;"> <?php echo e($users->User->first_name); ?>

                                                <?php echo e($users->User->last_name); ?></b>
                                        </div>
                                    </li>
...
<?php if(Auth::user()->role == 'admin'): ?>
                                <li style=" background: #2d2d2d; padding: 7px;">
                                    <div class="col-12">
                                        <a href="<?php echo e(url("$role/view")); ?>" 
        ...
        <div class="modal-dialog window-popup create-event" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(url("$role/add/event")); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                    ...
                    <input type="hidden" value="<?php if(isset($mang->id)): ?> <?php echo e($mang->id); ?> <?php endif; ?>" name="mangerID" id="">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cluster\cluster\resources\views\admin\Events-manager.blade.php ENDPATH**/ ?>