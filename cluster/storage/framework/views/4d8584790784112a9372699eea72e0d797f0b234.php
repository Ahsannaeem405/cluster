    ...
    <div class="row justify-content-center">
        <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                ...
                <form id="msform" class="install" method="POST" action="<?php echo e(url('install_saved')); ?>">
                    <?php echo csrf_field(); ?>
                    <!-- progressbar -->
                    <div class="row">
                        <div class="col-md-8 offset-md-2"> <ul id="progressbar">
                        <li class="active" id="account"><strong>Reqirment</strong></li>
                        <li id="personal"><strong>DataBase</strong></li>
                        <li id="payment"><strong>Admin</strong></li>
                    ...
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="fs-title">Server Requirement:</h2>
                                </div>
                                <div class="col-5">
...
unset($__errorArgs, $__bag); ?>  
                    ...
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="fs-title">Admin Credentials:</h2>
                                </div>
                                <div class="col-5">
...
</script><?php /**PATH C:\xampp\htdocs\cluster\cluster\resources\views/welcome.blade.php ENDPATH**/ ?>