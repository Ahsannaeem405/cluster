...
<a href="<?php echo e(url("$role/view/cluster",$list->id)); ?>">
                        <!-- Friend Item -->
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input list="browsers" name="manager_id" value="<?php echo e($list->manager_id); ?>"   placeholder="Select Manager"  class="form-control <?php $__errorArgs = ['manager_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">manager</label>
                            <input list="browsers" name="manager_id"  placeholder="Select Manager"  class="form-control <?php $__errorArgs = ['manager_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
