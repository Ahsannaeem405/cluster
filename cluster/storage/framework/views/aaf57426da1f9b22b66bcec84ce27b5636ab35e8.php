                      ...
                      <table class="table table-striped">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td class="py-2"><?php echo e($list->first_name); ?> <?php echo e($list->last_name); ?></td>
                                  <td><?php echo e($list->email); ?></td>
                                  
                                  <td>
                                      <div class="d-flex justify-content-end">
                                          <a data-bs-toggle="modal"  data-bs-toggle="modal" data-bs-target="#delete-new-member<?php echo e($list->id); ?>">
                                              <button class="mx-2 members-btns btn-danger">
                                                  <span>Delete </span><i class="fas fa-trash-alt"></i>
                                              </button>
                                          </a>
                                          
                                          <a data-bs-toggle="modal"  data-bs-toggle="modal" data-bs-target="#edit-new-member<?php echo e($list->id); ?>">
                              ...
                              <div class="modal fade" id="edit-new-member<?php echo e($list->id); ?>" tabindex="-1" role="dialog"
                              ...
                              <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form method="post" action="<?php echo e(url('admin/updateUser')); ?>/<?php echo e($list->id); ?>">
                                            <?php echo csrf_field(); ?> 
                                            <div class="form-group">
                                                  <label for="exampleFormControlInput1">Name</label>
                                                  <input type="text" name="first_name" value="<?php echo e($list->first_name); ?>" class="form-control" id="Cluster-Name" Value="Francine Smith">
...
unset($__errorArgs, $__bag); ?>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input type="email"  name="email" value="<?php echo e($list->email); ?>" class="form-control" id="Cluster-Name" Value="abc@xyz.com">
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="modal fade" id="delete-new-member<?php echo e($list->id); ?>" tabindex="-1" role="dialog"
                              aria-labelledby="create-friend-group-1" aria-hidden="true">
                              <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
                                  <div class="modal-content">
                                      <a href="#" class="close icon-close" data-bs-dismiss="modal" aria-label="Close">
                                      ...
                                      <div class="modal-header">
                                          <h6 class="title">Delete User<?php echo e($list->id); ?></h6>
                                      </div>
                                      ...
                                      <div class="modal-body">
                                          ...
                                          <div class="row">
                                              <div class="col-6">
                                                  <form method="post" action="<?php echo e(url('admin/deleteUser')); ?>/<?php echo e($list->id); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cluster\cluster\resources\views/admin/users.blade.php ENDPATH**/ ?>