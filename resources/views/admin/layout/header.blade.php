        ...
        <div class="header-content-wrapper">
            ...
            <div class="control-block">
                ...
                <div class="control-icon more has-items mt-2">
                    ...
                    <span style="position: absolute;backbround:red;background: red;width: 18px;
                    height: 18px;border-radius: 50%;padding: 0px 5px;color: white;
                    top: -9px;left: 9px;"><small>{{count($cluss)}}</small></span>
