                                                                ...
                                                                <div class="ui-block">
                                                                    <article class="hentry post video">
                                                                        ...
                                                                        <div class="col-12 text-center">
                                                                            ...
                                                                            <img style="min-height: 299px;max-height: 299px;width: 69%"
                                                                                loading="lazy"
                        ...
                        <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-6 col-12">
                                            ...
                                            <li class="inline-items">
                                                <div class="author-thumb">
                                                    @if (isset($managers->User->image))
                                                        <img alt="author"
                                                            src="{{ asset('images') }}/{{ $managers->User->image }}"
                            ...
                            <div class="ui-block text-center">
                                ...
                                <ul class="widget w-activity-feed notification-list">
                                    ...
                                    @if ($user->count() > 2 && Auth::user()->role == 'admin')
                                            ...
                                            <li>
                                                    <div class="author-thumb">
                                                        @if (isset($joinns->User->image))
                                                            <img alt="author"
                                                                src="{{ asset('images') }}/{{ $joinns->User->image }}"
                                                                width="36" height="36" class="avatar">
